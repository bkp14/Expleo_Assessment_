...
public class LoginDemo {
    ...
    @Test(dataProvider = "vdatas", dataProviderClass = ITestListeners.ExeclDataProvider.class, priority = 1)
    public void validLogin(String email, String password) {
        ...
        String actual = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.cssSelector("h2:nth-child(1)"))).getText();
    ...
    @Test(dataProvider = "ivdatas", dataProviderClass = ITestListeners.ExeclDataProvider.class, priority = 2)
